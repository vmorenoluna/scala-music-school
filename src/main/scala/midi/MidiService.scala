...
import performance.MEvent
import performance.Performance.{PTime, Performance}

import scala.util.Try

// essential service to write a midi file, VERY essential
object MidiService {
  ...
  private def eventToMidiEvents(event: MEvent): (MidiEvent, MidiEvent) = {
